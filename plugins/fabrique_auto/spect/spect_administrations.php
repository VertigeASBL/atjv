...
**/
function spect_upgrade($nom_meta_base_version, $version_cible) {
	$maj = array();
	# quelques exemples
	...
	#	array('ecrire_config', array('spect', array('exemple' => "Texte de l'exemple")))
	#);
	#
...
**/
function spect_vider_tables($nom_meta_base_version) {
	# quelques exemples
	# (que vous pouvez supprimer !)
	...
	sql_delete("spip_versions_fragments",    sql_in("objet", array('spectacle')));
	sql_delete("spip_forum",                 sql_in("objet", array('spectacle')));
